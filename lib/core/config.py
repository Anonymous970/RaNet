...
config.TAN.GRAPH_MODULE = edict()
config.TAN.GRAPH_MODULE.NAME = ''
config.TAN.GRAPH_MODULE.PARAMS = None
config.TAN.TEM_MODULE = edict()
config.TAN.TEM_MODULE.NAME = ''
config.TAN.TEM_MODULE.PARAMS = None
...
config.TAN.FUSION_MODULE1 = edict()
config.TAN.FUSION_MODULE1.NAME = ''
config.TAN.FUSION_MODULE1.PARAMS = None
config.TAN.FUSION_MODULE2 = edict()
config.TAN.FUSION_MODULE2.NAME = ''
config.TAN.FUSION_MODULE2.PARAMS = None
config.TAN.FUSION_MODULE3 = edict()
config.TAN.FUSION_MODULE3.NAME = ''
config.TAN.FUSION_MODULE3.PARAMS = None
