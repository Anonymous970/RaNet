...
def collate_fn(batch):
    ...
    batch_gt_action = torch.Tensor([b['gt_action'] for b in batch])
    batch_gt_start = torch.Tensor([b['gt_start'] for b in batch])
    batch_gt_end = torch.Tensor([b['gt_end'] for b in batch])
    ...
    batch_data = {
        ...
        'batch_gt_action': batch_gt_action,
        'batch_gt_start': batch_gt_start,
        'batch_gt_end': batch_gt_end,
    }
